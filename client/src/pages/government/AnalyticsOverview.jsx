    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          { title: 'Resolved', value: summary?.resolvedProblems || 0, icon: CheckCircle, color: 'text-accent-secondary' },
          { title: 'Active HEIs', value: summary?.activeHEIs || 0, icon: Building2, color: 'text-accent-primary' },
          ...
          <div key={idx} className="bg-[#16272B] p-6 rounded-xl border border-[#233E44] flex items-center gap-4">
            <div className={`p-3 rounded-lg bg-base ${kpi.color}`}>
              <kpi.icon size={24} />
            </div>
            <div>
              <p className="text-sm text-muted-custom">{kpi.title}</p>
